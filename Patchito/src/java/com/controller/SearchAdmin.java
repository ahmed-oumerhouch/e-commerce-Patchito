...
public class SearchAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int code = Integer.parseInt(request.getParameter("codesearch"));
        ArrayList<Produit> produitRecherche = new ArrayList<Produit>();
        Produit article = ProduitAction.getByCode(code);
        produitRecherche.add(article);
        request.setAttribute("mesProduits", produitRecherche);
